...
class SegImage {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SegImage
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SegImage
    let len;
    let data = new SegImage(null);
  ...
  static datatype() {
    ...
    return 'segmentation/SegImage';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '92227187f380ba6020a102f3e65a2aa2';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SegImage(null);
