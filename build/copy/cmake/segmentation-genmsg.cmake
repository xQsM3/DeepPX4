...
message(FATAL_ERROR "Could not find messages which '/home/xqsme/DeepPX4/src/copy/srv/Segmentation.srv' depends on. Did you forget to specify generate_messages(DEPENDENCIES ...)?
Cannot locate message [Header] in package [sensor_msgs] with paths [['/opt/ros/noetic/share/sensor_msgs/cmake/../msg']]")
message(STATUS "segmentation: 1 messages, 1 services")

set(MSG_I_FLAGS "-Isegmentation:/home/xqsme/DeepPX4/src/copy/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg;-Isensor_msgs:/opt/ros/noetic/share/sensor_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/xqsme/DeepPX4/src/copy/msg/SegImage.msg" NAME_WE)
add_custom_target(_segmentation_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "segmentation" "/home/xqsme/DeepPX4/src/copy/msg/SegImage.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(segmentation
  "/home/xqsme/DeepPX4/src/copy/msg/SegImage.msg"
  "${MSG_I_FLAGS}"
