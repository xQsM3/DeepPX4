...
class LocalPlanner {
  ...
  **/
  avoidanceOutput getAvoidanceOutput(double close_obst) const;
  ...
  **/
  ...
  /**
  * @brief     determines the strategy
  * @param[out] current planning strategy either normal, vertical or horizontal
  **/
  std::string getPlanDist();
  /**
