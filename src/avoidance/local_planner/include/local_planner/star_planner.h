...
class StarPlanner {
  ...
  **/
  void setGoal(const Eigen::Vector3f& pose);
    ...
    /**
    * @brief     setter method for sensor field of view in pitch deg
    * @param[in] fov_pitch_deg_, sensor field of view
    **/
  void setFovSensor(float fov_pitch_deg_);
